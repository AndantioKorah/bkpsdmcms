...
<div class="container">
	<div class="row">
		<div class="col-md-12 center">
			<h2>BIDANG<strong> TEKNIS</strong></h2>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-md-3 col-sm-6">
				<div class="featured-box featured-box-primary featured-box-effect-2" style="height: 206.2px;">
					<div class="box-content">
						...
						<h4>PENGADAAN, PEMBERHENTIAN DAN INFORMASI</h4>
			...
			<div class="col-md-3 col-sm-6">
				<div class="featured-box featured-box-tertiary featured-box-effect-2" style="height: 206.2px;">
					<div class="box-content">
						<i class="icon-featured fa fa-check-square"></i>
						<h4>PENGEMBANGAN APARATUR</h4>
						<a href="#" class="btn btn-tertiary mr-xs mb-lg">Klik Disini</a>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6">
				<div class="featured-box featured-box-quaternary featured-box-effect-2" style="height: 206.2px;">
					<div class="box-content">
						<i class="icon-featured fa fa-pencil-square"></i>
						<h4>PENILAIAN KINERJA APARATUR DAN PENGHARGAAN</h4>
						<a href="#" class="btn btn-tertiary mr-xs mb-lg">Klik Disini</a>
					</div>
				</div>
			</div>
...
<section class="section section-no-background m-none">
	<div class="container">
		...
		<div class="col-md-4" data-wow-delay=".4s">
			...
			?>
					<div class="recent-posts">
						<article class="post">
							<div class="post-meta">
								<span><i class="fa fa-calendar"></i>Hits: <?php echo $down['hits']; ?> </span>
							</div>
							<h5><a><?php echo $down['judul']; ?></a></h5>
						</article>
					</div>
			<?php
			 }
		...
		<div class="col-lg-4 col-md- col-sm-12 col-xs-12 welcome padding-left-none padding-bottom-40 scroll_effect fadeInUp">
			<h2 class="margin-bottom-25 margin-top-none"> <strong>PENGUMUMAN</strong></h2>
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				foreach ($bannerhome->result_array() as $ban2){ 
					if($no == 0){
					?>
						 <div class="item active"><a href="http://203.175.10.90/siladen/login/" target ="_blank"><img src="asset/foto_iklantengah/<?php echo $ban2['gambar']; ?>" alt="<?php echo $ban2['judul'];?>" caption="false" width="1288" height="627" /></a></div>
					<?php
					}else{
					?>
						<div class="item "><a href="http://203.175.10.90/siladen/login" target ="_blank"><img src="asset/foto_iklantengah/<?php echo $ban2['gambar']; ?>" alt="<?php echo $ban2['judul']; ?>" caption="false" width="1288" height="627" /></a></div>
					<?php
					}
					$no++;
				}
