	...
	<div class="col m12 s12">
		<div class="card">
			<div class="card-content">
				...
				<div class="row">
					<div class="col m12 s12">
						<a class="btn blue" href="<?=base_url('student/home/complete_profile');?>">Update Profil</a> <a class="btn blue" href="<?=base_url('student/home/reset_password');?>">Ganti Password</a>
					</div>
				</div>
