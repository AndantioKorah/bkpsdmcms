			...
			<div class="card-content">
				...
				<p>
					<ol>
						...
						<li><b>Kelas Ujian</b>, adalah daftar kelas yang sudah Anda ikuti / sudah bergabung ,</li>
						<li><b>Gabung Kelas</b>, adalah menu untuk Anda bergabung ke kelas ujian menggunakan kode kelas yang diberikan oleh <?=$this->config->item('teacher');?> / panitia ujian.</li>
					</ol>
				</p>
				...
				<p>
					<ol>
						<li>Klik  <b>Kelas Ujian</b> untuk melihat daftar kelas ujian,</li>
						<li>Apabila <?=$this->config->item('teacher');?> memberikan kode kelas, klik <b>Gabung Kelas</b> dan masukan kode kelasnya.</li>
