	...
	<div class="col m12 s12">
		<div class="card">
			<div class="card-content">
				...
				<hr/>
				<p>Pada Ujian ini terdapat sebuah paket soal yaitu <b><?=$quiz->title;?></b> dengan waktu pengerjaan selama <b><?=$quiz->time;?> menit</b>, paket soal ini 
					<?php 
					if ($classroom->working_status == 0) 
					{
						...
						echo " mulai bisa dikerjakan pada tanggal <b>". bulan_indo(strtotime($classroom->date_start))."</b> pukul <b>".$classroom->time_start." WITA</b> .<br/><br/>";
						...
						if (($classroom->date_start <= date('Y-m-d')) AND ($classroom->time_start <= date('H:i:s')) AND ($classroom->working_status != 2) AND  ($student_working_status->status != 2) ) {
							...
							if ($classroom->show_result == 1) {
								...
								<b style='font-size:70px;'><b>".number_format($score_total,2)."</b></b> dari 100</p>
								";
