				...
				<tr>
					...
					<td>
						<center>
							...
							<p>Alamat 	 :		<?=$this->config->item('address').' Kelurahan '.$this->config->item('village').' Kecamatan '.$this->config->item('sub_district').' <br/> '.$this->config->item('district').' - '.$this->config->item('province');?>.</p>
						</center>
					</td>
				</tr>
			</table>
