...
<head>
	...
	<div class="row" style="margin-top: 20px;">
			<table>
				<tr>
					<td width="95"><img src="<?=base_url('aila_cbt/images/logo.png');?>" width="85" style="margin-left: 10px;"></td>
					<td width="544"><h3 align="center">Pemerintah Kota Manado </h3>
					  <h3 align="center"> Badan Kepegawaian dan Pengembangan Sumber Daya Manusia </h3>
					  <p align="center">Alamat 	 :
					    <?=$this->config->item('address').' Kelurahan '.$this->config->item('village').' Kecamatan '.$this->config->item('sub_district').' <br/> '.$this->config->item('district').' - '.$this->config->item('province');?>
				    .</p></td>
					<td width="95">
						<center>
							<h3><img src="<?=base_url('aila_cbt/images/logocbtbkpsdm.jpg');?>" width="85" style="margin-left: 10px;"></h3>
					</center>					</td>
				</tr>
			</table>
			...
			<h4 style="margin: 0px 0px 5px 0px; text-align: center; padding-top: 10px;">REKAP NILAI UJIAN</h4>
			<table width="100%">
				<?php if (isset($student_score)) { ?>
					...
					<table width="711" border="0">
                      <tr>
                        <td width="336"><p align="center">Penanggung Jawab Ujian </p>
                        <p align="center">&nbsp;</p>
                        <p align="center">&nbsp;</p>
                        <p align="center">--------------------------</p></td>
                        <td width="365"><p align="center">Operator Ujian</p>
                        <p align="center">&nbsp;</p>
                        <p align="center">&nbsp;</p>
                        <p align="center">--------------------------</p></td>
                      </tr>
