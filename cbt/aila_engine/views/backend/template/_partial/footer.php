...
<script type="text/javascript" src="<?php echo base_url('');?>aila_cbt/js/jquery-ui.min.js"></script>
<script type="text/javascript" src="<?php echo base_url('');?>aila_cbt/js/materialize.min.js"></script>
<script type="text/javascript" src="<?php echo base_url('');?>aila_cbt/js/select2.min.js"></script>
...
<script type="text/javascript" src="<?php echo base_url('');?>aila_cbt/js/sweetalert2.all.min.js"></script>
